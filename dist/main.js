...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changeTempUnits: () => (/* binding */ changeTempUnits),
...
const displayWeather = (data, giph) => {
  ...
  const weekView = () => {
    ...
    const cardBuilder = (day) => {
      ...
      date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(`${day.date}T00:00`), "eee");
...
const initializer = () => {
  ...
  const dataObj = async (search) => {
    try {
      const weatherObj = await _modules_weather__WEBPACK_IMPORTED_MODULE_0__["default"].getData(search);
      const displayBuilder = (0,_modules_dom__WEBPACK_IMPORTED_MODULE_1__.displayWeather)(
        weatherObj.obj,
  ...
  unitChange.addEventListener("click", (e) => {
    ...
    (0,_modules_dom__WEBPACK_IMPORTED_MODULE_1__.changeTempUnits)(currentUnit);
  });
